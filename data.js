...
allSections.push(new Section("Math 2",0));
allSections.push(new Section("Math 3",0));
allSections.push(new Section("US History",0));
allSections.push(new Section("CS",0));
allSections.push(new Section("English",0));